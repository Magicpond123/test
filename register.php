...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO employees (username, password, firstname, lastname, mail, location, role, status) VALUES ('$username', '$password', '$firstname', '$lastname', '$mail', '$location', '$role', '$status')";
        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                ...
                <div class="sb-sidenav-footer">
                    <div class="small">เข้าสู่ระบบโดย:</div>
                    <?php if (isset($_SESSION['username'])): ?>
                        <?php echo $_SESSION['username']; ?>
                    <?php else: ?>
                        ผู้เยี่ยมชม
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">สมัครพนักงาน</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">สมัครพนักงาน</li>
                    </ol>
                    <div class="card mb-4">
                            ...
                            <form action="register.php" method="post">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" id="role" name="role" required>
                                        ...
                                        <option value="3">พนักงานต้อนรับ</option>
                                        <option value="4">พนักงานครัว</option>
                                    </select>
                                </div>
                                <div class="form-group mb-3">
                                ...
                                <button type="submit" class="btn btn-primary">สมัครพนักงาน</button>
                            </form>
                        </div>
                    </div>
                </div>
