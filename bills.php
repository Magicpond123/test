...
$sql = "SELECT p.payment_id, p.order_id, p.total_amount, p.payment_time, 
               o.table_id, o.adult, o.child, o.price_adult, o.price_child,
               t.table_number
        FROM payments p
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end"><?php echo number_format($bill_data['price_adult'], 2); ?></td>
                            <td class="text-end"><?php echo number_format($bill_data['adult'] * $bill_data['price_adult'], 2); ?></td>
                        </tr>
                        <tr>
                            <td>บุฟเฟต์เด็ก</td>
                            <td class="text-end"><?php echo $bill_data['child']; ?></td>
                            <td class="text-end"><?php echo number_format($bill_data['price_child'], 2); ?></td>
                            <td class="text-end"><?php echo number_format($bill_data['child'] * $bill_data['price_child'], 2); ?></td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
                            <td colspan="3" class="text-end"><strong>รวม</strong></td>
                            <td class="text-end"><?php echo number_format($subtotal + ($bill_data['adult'] * $bill_data['price_adult']) + ($bill_data['child'] * $bill_data['price_child']), 2); ?></td>
                        </tr>
                        <?php
                        if ($promotion) {
                            if ($promotion['type'] == 'discount-type-person') {
                                ...
                                $discount_amount = $bill_data['total_amount'] * ($promotion['discount_percent'] / 100);
                            }
                        ?>
                            <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-end"><strong><?php echo number_format($bill_data['total_amount'], 2); ?></strong></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
